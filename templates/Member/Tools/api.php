...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="well">
            <?= $this->Url->build('/', ['fullBase' => true]); ?>api/?api=<b><?= $user->api_token ?></b>&url=<b><?= urlencode('yourdestinationlink.com') ?></b>&alias=<b>CustomAlias</b>
        </div>

        <p><?= __('You will get a JSON reposnse like the following') ?></p>

        <div class="well">
            {"status":"success","shortenedUrl":"<?= json_encode($this->Url->build('/', ['fullBase' => true]) . 'xxxxx') ?>"}
        </div>
        ...
        <div class="well">
            <?= $this->Url->build('/', ['fullBase' => true]); ?>api/?api=<b><?= $user->api_token ?></b>&url=<b><?= urlencode('yourdestinationlink.com') ?></b>&alias=<b>CustomAlias</b>&format=<b>text</b>
        </div>
        ...
        <div class="well">
            $api_url = "<?= $this->Url->build('/', ['fullBase' => true]); ?>api/?api=<b><?= $user->api_token ?></b>&url=<b><?= urlencode('yourdestinationlink.com') ?></b>&alias=<b>CustomAlias</b>";<br>
        ...
        <div class="well">
            $api_url = "<?= $this->Url->build('/', ['fullBase' => true]); ?>api/?api=<b><?= $user->api_token ?></b>&url=<b><?= urlencode('yourdestinationlink.com') ?></b>&alias=<b>CustomAlias</b>&format=<b>text</b>";<br>
