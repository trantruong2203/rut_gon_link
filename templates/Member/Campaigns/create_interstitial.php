...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p class="help-block"><?= __('Thời gian bộ đếm ngược hiển thị code vượt link.') ?></p>
        ...
        <div id="anchor-specify-fields" style="display: none;">
            <?= $this->Form->control('anchor_text', ['label' => __('Anchor text'), 'class' => 'form-control']); ?>
            <?= $this->Form->control('anchor_link', ['label' => __('Link anchor'), 'type' => 'url', 'class' => 'form-control']); ?>
        </div>
        ...
        <p class="help-block"><?= __('View từ đâu cũng tính. Giá tự động theo Tổng view và Thời gian countdown. Chia 50-50 với nền tảng.') ?></p>
        ...
        <div class="well" id="price-summary">
            ...
            <p><strong><?= __('Bạn nhận / 1 view') ?>:</strong> <span id="publisher-per-view">-</span> (50%)</p>
        ...
        <div class="text-center">
            <?= $this->Form->button(__('Mua Dịch Vụ'), ['class' => 'btn btn-success btn-lg']); ?>
        </div>
...
$(document).ready(function() {
    $('input[name="anchor_mode"]').on('change', function() {
        $('#anchor-specify-fields').toggle($(this).val() === 'specify');
    });
