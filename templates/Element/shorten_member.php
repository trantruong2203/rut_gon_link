...
<?= $this->Form->button(__('Shorten'), ['class' => 'btn btn-submit btn-primary btn-xs']); ?> <button type="button" class="btn btn-default btn-xs advanced"><?= __('Advanced Options') ?></button>
