<?php
$this->assign('title', __('Edit SEO Campaign'));
$this->assign('description', '');
$this->assign('content_title', __('Edit SEO Campaign'));
...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="form-group">
            <label><?= __('Current Image 1') ?></label>
            <div>
                <img src="<?= h($campaign->seo_image_1) ?>" style="max-width: 300px; max-height: 200px;" class="img-thumbnail">
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="form-group">
            <label><?= __('Current Image 2') ?></label>
            <div>
                <img src="<?= h($campaign->seo_image_2) ?>" style="max-width: 300px; max-height: 200px;" class="img-thumbnail">
            </div>
        </div>
        <?php endif; ?>
        ...
        <?= $this->Form->control('keyword_seo_status', [
            'label' => __('Status'),
            'options' => $seoStatuses,
            'class' => 'form-control'
        ]); ?>

        <?= $this->Form->button(__('Update Campaign'), ['class' => 'btn btn-primary']); ?>
