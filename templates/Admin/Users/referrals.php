    ...
    <div class="box-body no-padding">
        ...
        <table class="table table-hover table-striped">
            ...
            <?php foreach ($referrals as $referral): ?>
                <tr>
                    <td><?= $this->Html->link($referral->username, ['controller' => 'Users', 'action' => 'view', $referral->id]); ?></td>
                    <td><?= $this->Html->link($referral->referred_by_username, ['controller' => 'Users', 'action' => 'view', $referral->referred_by]); ?></td>
