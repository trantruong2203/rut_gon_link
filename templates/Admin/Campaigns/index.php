...
<?php $verificationStatuses = \App\Service\CampaignVerificationService::getVerificationStatuses(); ?>
...
<div class="box box-solid">
    <div class="box-body">
        ...
        <?=
        $this->Form->input('Filter.verification_status', [
            'label' => false,
            'options' => $verificationStatuses,
            'empty' => __('Verification'),
            'class' => 'form-control'
        ]);
        ?>
        ...
        <table class="table table-hover table-striped">
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('Campaigns.verification_status', __('Verification')); ?></th>
            ...
            <?php foreach ($campaigns as $campaign): ?>
                <tr>
                    ...
                    <td><?= h($verificationStatuses[(int)$campaign->verification_status] ?? __('Unverified')) ?></td>
