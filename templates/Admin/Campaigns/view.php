...
<div class="box box-primary">
    <div class="box-body">
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                <td><?= __('Verification Checked') ?></td>
                <td><?= !empty($campaign->verification_checked_at) ? display_date_timezone($campaign->verification_checked_at) : __('Not checked yet') ?></td>
            </tr>
            <tr>
                <td><?= __('Verification Note') ?></td>
