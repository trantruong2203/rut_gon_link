        ...
        <table class="table table-hover table-striped">
            ...
            <?php foreach ($testimonials as $testimonial): ?>
                <tr>
                    ...
                    <td>
                        <?= $this->Html->link($testimonial->name, ['action' => 'edit', $testimonial->id, '?' => ['lang' => get_option('language', 'en_US')]]); ?> <?= $this->Html->link(get_option('language', 'en_US'), ['action' => 'edit', $testimonial->id, '?' => ['lang' => get_option('language', 'en_US')] ], ['class' => 'label label-primary']); ?><br>
                        <p>
                        <?php foreach (get_site_languages() as $lang) : ?>
                            <?= $this->Html->link($lang, ['action' => 'edit', $testimonial->id, '?' => ['lang' => $lang]], ['class' => 'label label-default']); ?>
                        <?php endforeach; ?>
                        </p>
                    </td>
                    ...
                    <td><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $testimonial->id], ['confirm' => __('Are you sure?'), 'class' => 'btn btn-danger btn-xs']); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
