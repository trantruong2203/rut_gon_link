...
class Version320 extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $items = implode(",", [
            "'site_languages'", "'disable_meta_home'", "'disable_meta_member'", "'disable_meta_api'",
            "'main_domain'", "'multi_domains'", "'default_short_domain'", "'theme'",
            "'fake_clicks'", "'fake_clicks'", "'fake_users'"
        ]);
