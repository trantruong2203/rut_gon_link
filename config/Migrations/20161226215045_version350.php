...
class Version350 extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $items = implode(",", [
            "'social_login_facebook'", "'social_login_facebook_app_id'", "'social_login_facebook_app_secret'",
            "'social_login_twitter'", "'social_login_twitter_api_key'", "'social_login_twitter_api_secret'",
            "'social_login_google'", "'social_login_google_client_id'", "'social_login_google_client_secret'",
            "'blog_enable'", "'blog_comments_enable'", "'disqus_shortname'", "'ssl_enable'",
            "'google_safe_browsing_key'", "'phishtank_key'", "'close_registration'",
            "'enable_captcha_shortlink_anonymous'", "'skrill_enable'", "'skrill_email'", "'skrill_secret_word'",
            "'wallet_enable'"
        ]);
