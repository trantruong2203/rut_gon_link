...
class Version300 extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $items = implode(",", [
            "'link_info_public'", "'link_info_member'", "'coinbase_enable'", "'coinbase_api_key'",
            "'coinbase_api_secret'", "'coinbase_sandbox'", "'banktransfer_enable'", "'banktransfer_instructions'",
            "'home_shortening'", "'home_shortening_register'"
        ]);
