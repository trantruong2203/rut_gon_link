...
var captchaInterstitial;

var onloadCallback = function () {

    if ($('#captchaInterstitial').length) {
        captchaInterstitial = grecaptcha.render('captchaInterstitial', {
            'sitekey': app_vars['reCAPTCHA_site_key'],
            'callback': function() {
                $('#go-submit, #go-submit-2').prop('disabled', false).removeClass('disabled');
            },
            'expired-callback': function() {
                $('#go-submit, #go-submit-2').prop('disabled', true).addClass('disabled');
            }
        });
    }
